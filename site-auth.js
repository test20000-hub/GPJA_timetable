(()=>{
  ...
  const PASSWORD='0511';
  const loadTheme=()=>{if(document.querySelector('script[data-gpja-theme]'))return;const s=document.createElement('script');s.src='theme.js?v=1.5.7';s.defer=true;s.dataset.gpjaTheme='1';document.head.appendChild(s)};
